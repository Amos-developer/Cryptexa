  ...
  <div class="row">
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
      <div class="stat-card">
        ...
        <div class="stat-value">{{ $pools->total() }}</div>
      </div>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
      <div class="stat-card green">
        ...
        <div class="stat-value">${{ number_format($pools->sum('price'), 2) }}</div>
      </div>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
      <div class="stat-card orange">
        ...
        <div class="stat-value">${{ number_format($pools->avg('max_profit'), 2) }}</div>
      </div>
    </div>
  </div>
