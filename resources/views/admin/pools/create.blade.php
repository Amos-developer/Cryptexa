    ...
    <form action="{{ route('admin.pools.store') }}" method="POST">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <span class="input-prefix">$</span>
            <input type="number" step="0.01" min="0" name="min_profit" class="form-input @error('min_profit') error @enderror" value="{{ old('min_profit') }}" required>
          </div>
          @error('min_profit')
            <span class="error-message">{{ $message }}</span>
          @enderror
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <span class="input-prefix">$</span>
            <input type="number" step="0.01" min="0" name="max_profit" class="form-input @error('max_profit') error @enderror" value="{{ old('max_profit') }}" required>
          </div>
          @error('max_profit')
            <span class="error-message">{{ $message }}</span>
          @enderror
