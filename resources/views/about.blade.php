...
<div class="team-header">
    ...
    <h6 class="header-title">About Cryptexa</h6>
    ...
    <div class="tf-container">
        ...
        <div style="text-align: center; margin-bottom: 40px; animation: slideDown 0.6s ease;">
            ...
            <p style="color: #94a3b8; font-size: 14px; max-width: 500px; margin: 0 auto; line-height: 1.6;">
                Your trusted platform for automated cryptocurrency investment vaults
            </p>
        </div>
        ...
        <div style="background: linear-gradient(135deg, rgba(56,189,248,0.05), rgba(56,189,248,0.02)); border: 1px solid rgba(56,189,248,0.15); border-radius: 16px; padding: 24px; margin-bottom: 20px; animation: slideUp 0.6s ease 0.2s backwards;">
            ...
            <h3 style="color: #e5e7eb; font-weight: 800; font-size: 20px; margin: 0 0 12px 0;">Automated Investment Vaults</h3>
            <p style="color: #94a3b8; font-size: 14px; line-height: 1.7; margin: 0;">
                Cryptexa offers automated investment vaults with daily compounding returns. Our platform provides secure, hands-free crypto investing with 5 vault tiers designed to maximize your returns.
            </p>
        </div>
        ...
        <div style="background: linear-gradient(180deg, rgba(255,255,255,0.02), rgba(255,255,255,0.01)); border: 1px solid rgba(255,255,255,0.06); border-radius: 16px; padding: 24px; margin-bottom: 20px; animation: slideUp 0.6s ease 0.3s backwards;">
            ...
            <div style="display: grid; gap: 16px;">
                <div style="display: flex; gap: 16px; padding: 16px; background: rgba(56,189,248,0.05); border-radius: 12px;">
                    <div style="width: 48px; height: 48px; background: rgba(56,189,248,0.15); border: 1px solid rgba(56,189,248,0.3); border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 24px; flex-shrink: 0;">🔐</div>
                    <div>
                        <h4 style="color: #e5e7eb; font-weight: 700; font-size: 15px; margin: 0 0 6px 0;">Automated Investment Vaults</h4>
                        <p style="color: #94a3b8; font-size: 13px; margin: 0; line-height: 1.5;">5 vault tiers (Bronze to Diamond) with daily returns from 1.5% to 3.5% and automatic compounding - set it and forget it</p>
                    </div>
                </div>
                <div style="display: flex; gap: 16px; padding: 16px; background: rgba(34,197,94,0.05); border-radius: 12px;">
                    ...
                    <div>
                        ...
                        <p style="color: #94a3b8; font-size: 13px; margin: 0; line-height: 1.5;">Earn bonus rewards daily with streak multipliers - consistent check-ins unlock higher rewards</p>
                    </div>
                </div>
                <div style="display: flex; gap: 16px; padding: 16px; background: rgba(251,191,36,0.05); border-radius: 12px;">
                    ...
                    <div>
                        <h4 style="color: #e5e7eb; font-weight: 700; font-size: 15px; margin: 0 0 6px 0;">Lucky Box & Weekly Salary</h4>
                        <p style="color: #94a3b8; font-size: 13px; margin: 0; line-height: 1.5;">Open mystery boxes for instant prizes and receive weekly salary based on your investment level</p>
                    </div>
                </div>
                <div style="display: flex; gap: 16px; padding: 16px; background: rgba(168,85,247,0.05); border-radius: 12px;">
                    ...
                    <div>
                        <h4 style="color: #e5e7eb; font-weight: 700; font-size: 15px; margin: 0 0 6px 0;">3-Level Referral System</h4>
                        <p style="color: #94a3b8; font-size: 13px; margin: 0; line-height: 1.5;">Earn 2% on Level 1, 1% on Level 2, and 0.5% on Level 3 referral deposits - build your network and earn passive income</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="background: linear-gradient(135deg, rgba(168,85,247,0.05), rgba(168,85,247,0.02)); border: 1px solid rgba(168,85,247,0.15); border-radius: 16px; padding: 24px; margin-bottom: 20px; animation: slideUp 0.6s ease 0.4s backwards;">
            <h2 style="color: #a855f7; font-weight: 700; font-size: 13px; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 16px 0;">🔐 Security & Trust</h2>
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px;">
                <div style="text-align: center;">
                    <div style="width: 48px; height: 48px; background: rgba(168,85,247,0.15); border-radius: 10px; display: flex; align-items: center; justify-content: center; margin: 0 auto 12px; font-size: 24px;">🔒</div>
                    <h4 style="color: #e5e7eb; font-weight: 700; font-size: 14px; margin: 0 0 6px 0;">Secure Platform</h4>
                    <p style="color: #94a3b8; font-size: 12px; margin: 0; line-height: 1.5;">Advanced encryption & security protocols</p>
                </div>
                <div style="text-align: center;">
                    <div style="width: 48px; height: 48px; background: rgba(168,85,247,0.15); border-radius: 10px; display: flex; align-items: center; justify-content: center; margin: 0 auto 12px; font-size: 24px;">⚡</div>
                    <h4 style="color: #e5e7eb; font-weight: 700; font-size: 14px; margin: 0 0 6px 0;">Instant Withdrawals</h4>
                    <p style="color: #94a3b8; font-size: 12px; margin: 0; line-height: 1.5;">Fast processing of withdrawal requests</p>
                </div>
                <div style="text-align: center;">
                    <div style="width: 48px; height: 48px; background: rgba(168,85,247,0.15); border-radius: 10px; display: flex; align-items: center; justify-content: center; margin: 0 auto 12px; font-size: 24px;">📊</div>
                    <h4 style="color: #e5e7eb; font-weight: 700; font-size: 14px; margin: 0 0 6px 0;">Transparent ROI</h4>
                    <p style="color: #94a3b8; font-size: 12px; margin: 0; line-height: 1.5;">Clear returns with daily compounding</p>
                </div>
            </div>
        </div>

        <!-- Contact -->
        <div style="background: linear-gradient(135deg, rgba(34,197,94,0.05), rgba(34,197,94,0.02)); border: 1px solid rgba(34,197,94,0.15); border-radius: 16px; padding: 24px; text-align: center; animation: slideUp 0.6s ease 0.5s backwards;">
            <h2 style="color: #22c55e; font-weight: 700; font-size: 16px; margin: 0 0 12px 0;">💬 Get Support</h2>
            <p style="color: #94a3b8; font-size: 14px; margin: 0 0 16px 0; line-height: 1.6;">
                Have questions? Our support team is available 24/7 to assist you with any inquiries.
            </p>
            <a href="{{ route('account.settings') }}" style="display: inline-block; padding: 12px 24px; background: linear-gradient(135deg, rgba(34,197,94,0.2), rgba(34,197,94,0.1)); border: 1px solid rgba(34,197,94,0.3); border-radius: 10px; color: #22c55e; font-weight: 600; font-size: 14px; text-decoration: none; transition: all 0.3s ease;"
                onmouseover="this.style.background='linear-gradient(135deg, rgba(34,197,94,0.3), rgba(34,197,94,0.15))'; this.style.boxShadow='0 0 20px rgba(34,197,94,0.2)';" 
                onmouseout="this.style.background='linear-gradient(135deg, rgba(34,197,94,0.2), rgba(34,197,94,0.1))'; this.style.boxShadow='none';">
                Contact Support
            </a>
        </div>
